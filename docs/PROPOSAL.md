...
# etc/schema.graphqls
type Query {
    customProduct(sku: String!): CustomProduct @resolver(class: "Vendor\\Module\\Model\\Resolver\\CustomProduct")
}
...
**Additional behavior (v1.1+):**
4. Confirm checksum matches local manifest (remote skills)
5. If registry provides signatures, verify them
